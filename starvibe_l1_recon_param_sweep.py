...
def run_l1_param_sweep_single_gate(data_bins, spoke_bins, mps, img_shape, 
    ...
    if output_dir is None:
        output_dir = Path('l1_sweep_results')
    else:
    ...
    for lam in lambda_values:
        ...
        try:
            alg_tv = L1WaveletRecon(data_bins[gate_idx], mps,
    ...
    if save_results:
        results_file = output_dir/f'l1_sweep_gate{gate_idx}_lambda{len(lambda_values)}.pkl'
...
if __name__ == '__main__':
    ...
    gate_idx_to_reconstruct = 0
    lambda_values = [1e-5, 1e-4]
    final_recon = run_l1_param_sweep_single_gate(data_bins, spoke_bins, mps, img_shape, 
